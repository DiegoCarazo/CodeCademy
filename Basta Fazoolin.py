class Menu:
  ...
  def __repr__(self):
    return self.name + 'Menu avaialable from ' + str(self.start_time) + ' - ' + str(self.end_time)
...
farzoolin = Business("Basta Fazoolin' with my Heart",[flagship_store, new_installment])

arepas_items = {'arepa pabellon': 7.00, 'pernil arepa': 8.50, 'guayanes arepa': 8.00, 'jamon arepa': 7.50}

arepas_menu = Menu("Take a Arepa ", arepas_items, 1000, 2000)

arepas_pace = ("189 Fitzgerald Avenue", [arepas_menu])
...
print(early_bird_menu.calculate_bill(['pancakes', 'salumeria plate', 'mushroom ravioli (vegan)']))
